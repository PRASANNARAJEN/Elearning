...
?>  
    ...
    <div class="container-fluid remove-vid-marg">
      <div class="vid-parent">
        <video playsinline autoplay muted loop>
          <source src="video/videoplayba.mp4" />
        </video>
        <div class="vid-overlay"></div>
      </div>
      <div class="vid-content" >
        <h1 class="my-content"><SPAN>BEGIN THE JOURNEY </SPAN></BR>EASE LEARN </h1>
    ...
    <div class="container mt-5"> <!-- Start Most Popular Course -->
      ...
      <div class="card-deck mt-4"> <!-- Start Most Popular Course 1st Card Deck -->
        <?php
       // $pg_query = "SELECT * FROM course LIMIT 3";
        $result = pg_query($conn,"SELECT * FROM course LIMIT 3");
      ...
      <div class="card-deck mt-4"> <!-- Start Most Popular Course 2nd Card Deck -->
        <?php
         // $pg_sql = "SELECT * FROM course LIMIT 3,3";
          $result = pg_query($conn,"SELECT * FROM course LIMIT 3");
         // $result = $conn->query($pg_sql);
          if($row=pg_num_rows($result)> 0){ 
            while($row = pg_fetch_assoc($result)){
              $course_id = $row['course_id'];
              echo '
          ...
          <div class="col-md-12">
            ...
            <?php 
             // $sql = "SELECT s.stu_name, s.stu_occ, s.stu_img, f.f_content FROM student AS s JOIN feedback AS f ON s.stu_id = f.stu_id";
              ...
              $result = pg_query($conn,"SELECT s.stu_name, s.stu_occ, s.stu_img, f.f_content FROM student AS s JOIN feedback AS f ON s.stu_id = f.stu_id");
              if($row=pg_num_rows($result)> 0) {
                while($row =pg_fetch_assoc($result)){
                  $s_img = $row['stu_img'];
    ...
    <div class="container-fluid p-4" style="background-color:#E9ECEF">
      <div class="container" style="background-color:#E9ECEF">
        <div class="row text-center">
          <div class="col-sm">
            <h5>About Us</h5>
              <p>EASE LEARN provides universal access to the world’s best education, partnering with top universities and organizations to offer courses online.</p>
          </div>
          <div class="col-sm">
            <h5>Category</h5>
          ...
          <div class="col-sm">
            <h5>Contact Us</h5>
            <p>EASE LEARN Pvt Ltd <br> Near Police Camp II <br> Bokaro, Jharkhand <br> Ph. 000000000 </p>
          </div>
        </div>
      </div>
