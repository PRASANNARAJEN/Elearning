...
include_once('../dbConnection.php');
 ...
 $result =pg_query( $conn, "SELECT * FROM student WHERE stu_email='$stuEmail'");
 ...
 if(isset($_REQUEST['updateStuNameBtn'])){
  if(($_REQUEST['stuName'] == "")){
   ...
   $result = pg_query($conn,"UPDATE student SET stu_name = '$stuName', stu_occ = '$stuOcc', stu_img = '$img_folder' WHERE stu_email = '$stuEmail'");
   if(($result) == TRUE){
