...
if(isset($_POST['stuemail']) && isset($_POST['checkemail'])){
  ...
  $result = pg_query($conn, "SELECT stu_email FROM student WHERE stu_email='".$stuemail."'");
  ...
  if(isset($_POST['stusignup'])  && isset($_POST['stuname']) && isset($_POST['stuemail']) && isset($_POST['stupass'])){
    ...
    $result =pg_query($conn,"INSERT INTO student(stu_name, stu_email, stu_pass) VALUES ('$stuname', '$stuemail', '$stupass')");
    if($result == TRUE){
      echo json_encode("OK");
    } else {
  ...
  if(!isset($_SESSION['is_login'])){
    if(isset($_POST['checkLogemail']) && isset($_POST['stuLogEmail']) && isset($_POST['stuLogPass'])){
      ...
      $result =pg_query( $conn, "SELECT stu_email, stu_pass FROM student WHERE stu_email='".$stuLogEmail."' AND stu_pass='".$stuLogPass."'");
