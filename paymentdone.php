...
if(!isset($_SESSION['stuLogEmail'])) {
 ...
 if(isset($_POST['ORDER_ID']) && isset($_POST['TXN_AMOUNT'])){
  ...
  $result=pg_query($conn,"INSERT INTO courseorder(order_id, stu_email, course_id, status, respmsg, amount, order_date) VALUES ('$order_id', '$stu_email', '$course_id', '$status', '$respmsg', '$amount', '$date')");
   if($result == TRUE){
