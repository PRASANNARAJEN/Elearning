...
include('../dbConnection.php');
 ...
 if(isset($_REQUEST['requpdate'])){
  ...
  if(($_REQUEST['lesson_id'] == "") || ($_REQUEST['lesson_name'] == "") || ($_REQUEST['lesson_desc'] == "") || ($_REQUEST['course_id'] == "") || ($_REQUEST['course_name'] == "")){
   ...
   $result =pg_query($conn, "UPDATE lesson SET lesson_id = '$lid', lesson_name = '$lname', lesson_desc = '$ldesc', course_id='$cid', course_name='$cname', lesson_link='$llink' WHERE lesson_id = '$lid'");
    if(($result) == TRUE){
...
<div class="col-sm-6 mt-5  mx-3 jumbotron">
 ...
 $result = pg_query($conn,"SELECT * FROM lesson WHERE lesson_id = {$_REQUEST['id']}");
