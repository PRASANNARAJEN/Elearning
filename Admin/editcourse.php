...
include('../dbConnection.php');
 ...
 if(isset($_REQUEST['requpdate'])){
  ...
  if(($_REQUEST['course_id'] == "") || ($_REQUEST['course_name'] == "") || ($_REQUEST['course_desc'] == "") || ($_REQUEST['course_author'] == "") || ($_REQUEST['course_duration'] == "") || ($_REQUEST['course_price'] == "") || ($_REQUEST['course_original_price'] == "")){
   ...
   $result= pg_query($conn,"UPDATE course SET course_id = '$cid', course_name = '$cname', course_desc = '$cdesc', course_author='$cauthor', course_duration='$cduration', course_price='$cprice', course_original_price='$coriginalprice', course_img='$cimg' WHERE course_id = '$cid'");
    if(($result) == TRUE){
...
<div class="col-sm-6 mt-5  mx-3 jumbotron">
 ...
 $result =pg_query( $conn,"SELECT * FROM course WHERE course_id = {$_REQUEST['id']}");
