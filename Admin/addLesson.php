 ...
 if(isset($_REQUEST['lessonSubmitBtn'])){
  ...
  if(($_REQUEST['lesson_name'] == "") || ($_REQUEST['lesson_desc'] == "") || ($_REQUEST['course_id'] == "") || ($_REQUEST['course_name'] == "")){
   ...
   move_uploaded_file($lesson_link_temp, $link_folder);
    $result =pg_query($conn, "INSERT INTO lesson (lesson_name, lesson_desc, lesson_link, course_id, course_name) VALUES ('$lesson_name', '$lesson_desc','$link_folder', '$course_id', '$course_name')");
    if(($result) == TRUE){
