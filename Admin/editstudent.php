...
include('../dbConnection.php');
 ...
 if(isset($_REQUEST['requpdate'])){
  ...
  if(($_REQUEST['stu_id'] == "") || ($_REQUEST['stu_name'] == "") || ($_REQUEST['stu_email'] == "") || ($_REQUEST['stu_pass'] == "") || ($_REQUEST['stu_occ'] == "")){
   ...
   $result =pg_query($conn, "UPDATE student SET stu_id = '$sid', stu_name = '$sname', stu_email = '$semail', stu_pass='$spass', stu_occ='$socc' WHERE stu_id = '$sid'");
    if(($result) == TRUE){
...
<div class="col-sm-6 mt-5  mx-3 jumbotron">
 ...
 $result = pg_query($conn,"SELECT * FROM student WHERE stu_id = {$_REQUEST['id']}");
