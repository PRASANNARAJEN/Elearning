...
$result =pg_query($conn,"SELECT * FROM course");
$totalcourse = pg_num_rows($result);

 //$sql = "SELECT * FROM student";
 $result = pg_query($conn,"SELECT * FROM student");
 $totalstu = pg_num_rows($result);

 //$sql = "SELECT * FROM courseorder";
 $result =pg_query( $conn, "SELECT * FROM courseorder");
 $totalsold = pg_num_rows($result);
?>
  ...
  if(isset($_REQUEST['delete'])){
    $result = pg_query($conn,"DELETE FROM courseorder WHERE co_id = {$_REQUEST['id']}");
    if(($result) === TRUE){
